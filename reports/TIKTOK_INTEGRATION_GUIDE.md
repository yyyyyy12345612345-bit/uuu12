...
# رابط الـ Webhook الخاص بـ Make.com (اختياري)
# عند إضافته، سيتم تحويل الرفع التلقائي لـ Make بدلاً من الرفع المباشر
MAKE_WEBHOOK_URL=https://hook.us1.make.com/your_unique_webhook_id
```

---

## 🔗 التكامل البديل مع Make.com (Make.com Automation Option)

إذا كنت تفضل استخدام منصة **Make.com** لإدارة عملية رفع الفيديوهات (مما يغنيك عن استهلاك موارد السيرفر في معالجة الـ Chunks ويوفر تجديد رموز الوصول تلقائياً عبر موديول تيك توك في Make)، يمكنك ببساطة:
1. إنشاء **Scenario** جديد في Make.com.
2. إضافة موديول **Custom Webhook** ونسخ الرابط الممنوح.
3. إضافة موديول **TikTok (Post a Video)** وربطه بالويب هوك.
4. إضافة المتغير البيئي `MAKE_WEBHOOK_URL` برابط الويب هوك الخاص بك.
5. سيقوم الكود تلقائياً باكتشاف وجود الويب هوك وتوجيه الفيديوهات (الفورية والمجدولة) إليه مباشرة مع الاحتفاظ بنظام التحديثات وسجلات النشر في واجهة الأدمن.
