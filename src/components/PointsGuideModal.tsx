...
import { 
  X, BookOpen, Headphones, Calendar, 
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[5000] flex items-center justify-center p-4 md:p-8 font-arabic">
          ...
          <motion.div 
            ...
            className="relative w-full max-w-2xl bg-[#0c0d10] border border-primary/20 rounded-[3rem] shadow-[0_0_100px_rgba(16,185,129,0.15)] overflow-hidden flex flex-col h-[85vh] md:h-auto md:max-h-[90vh] force-dark"
          >
            {/* Background Pattern */}
            ...
            <div className="relative z-10 p-8 border-t border-white/10 bg-black/20 text-center">
              <p className="text-[10px] font-black text-white/20 uppercase tracking-[0.4em]">نظام النقاط العالمي V 21 - سكينة</p>
            </div>
          </motion.div>
        </div>
      )}
