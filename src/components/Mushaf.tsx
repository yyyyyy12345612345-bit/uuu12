                ...
                <div className="flex flex-col gap-12 md:gap-24">
                    {surahContent?.verses.map((verse: any) => (
                        <div 
                            key={verse.id} 
                            id={`verse-${verse.id}`}
                            className={`group relative transition-all duration-700 p-5 md:p-8 rounded-[2rem] border ${playingAyah === verse.id ? 'bg-primary/[0.04] border-primary/30 shadow-2xl shadow-primary/5' : 'bg-white/[0.01] border-transparent hover:border-white/10'}`}
                        >
