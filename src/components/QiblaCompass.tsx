...
const KaabaIcon = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 64 64" fill="currentColor" className={className}>
    ...
    {/* Kaaba Door pattern */}
    <path d="M39 33 L43 35 L43 43 L39 41 Z" fill="#18181b" opacity="0.4" />
  </svg>
);
      ...
      <div className={`w-full max-w-sm p-4 text-right flex items-start gap-3 ${CARD_BG} border-amber-500/20 bg-amber-500/[0.02]`}>
        ...
        <div className="space-y-1">
          ...
          <p className="text-[10.5px] text-white/50 leading-relaxed font-semibold">
            البوصلة الإلكترونية للهواتف قد تتأثر بالمجالات المغناطيسية أو المعادن المحيطة. للحصول على أقصى دقة، يُرجى دائماً التحقق من اتجاه القبلة من مصدر موثوق ومسؤول (مثل محراب أقرب مسجد لديك).
          </p>
        </div>
      </div>
