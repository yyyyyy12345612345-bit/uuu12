...
const MODES: ChoiceMode[] = [
  {
    ...
    bgGradientClass: "from-[#faf6ee]/50 to-white/20 dark:from-zinc-900/40 dark:to-zinc-950/20 backdrop-blur-md",
  ...
  },
  {
    ...
    bgGradientClass: "from-[#f4fbf7]/50 to-white/20 dark:from-zinc-900/40 dark:to-zinc-950/20 backdrop-blur-md",
  ...
  },
  {
    ...
    bgGradientClass: "from-[#f0f7ff]/50 to-white/20 dark:from-zinc-900/40 dark:to-zinc-950/20 backdrop-blur-md",
