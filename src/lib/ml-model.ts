...
اسألني الآن عن أي نقطة تريدها في هذا التطبيق، وسأعطيك شرحاً مفصلاً خطوة بخطوة.`,
  ...
  const downloadQueryMatch = /(?:تحميل تطبيق|تنزيل تطبيق|تنزيل apk|تحميل apk|APK|install app|تحميل التطبيق|ازاي انزل تطبيق|كيف انزل تطبيق|ازاي انزل apk|تحميل apk)/i.test(textClean);
...
إليك بعض الطرق التي يمكنني مساعدتك بها الآن:
• 🎥 أنشئ فيديو قرآني احترافي من /video
• 📖 اقرأ المصحف مع التفسير من /mushaf-full
• 🎧 استمع لأفضل التلاوات من /library
• 🕋 تعرف على مواقيت الصلاة واتجاه القبلة من /prayers
• 🏆 تابع ترتيبك ونقاطك من /rank
• 🛡️ افتح يومياتي للأذكار والسبحة من /daily

إذا كنت تريد شرح مفصل لأي قسم، فقط اسألني مثل: "اشرح لي صفحة الفيديو" أو "كيف أستخدم المكتبة الصوتية؟" 🌸`,
    score: highestSimilarity,
    category: "افتراضي"
  };
}
