...
const CHANNEL_ID = 'prayer_notifications_v22';
const SETTINGS_KEY = 'prayer_notif_settings_v22';
const CACHE_KEY = 'prayer_times_cache';
const LAST_SCHEDULE_DATE_KEY = 'last_schedule_date_v22';
...
const TRIGGERED_KEY = 'adhan:triggered:v22';
