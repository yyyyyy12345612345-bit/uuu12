...
- الاسم الرسمي: يقين | Yaqeen (الحزمة: com.yaqeen.app)
...
- الاستضافة: Vercel (الموقع الرئيسي)، Hugging Face Spaces (خادوم تصيير ورندر الفيديوهات)، Cloudflare Workers (الـ API باسم uuu12)
