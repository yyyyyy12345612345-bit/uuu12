...
- الاسم الرسمي: يقين | Yaqeen (رابط الموقع: https://yaqeen-app.vercel.app) (اسم حزمة تطبيق الأندرويد: com.yaqeen.app)
...
- الاستضافة: Vercel (رابط الموقع والويب: https://yaqeen-app.vercel.app)، Hugging Face Spaces (خادوم تصيير ورندر الفيديوهات)، Cloudflare Workers (الـ API باسم uuu12)
